...
#Region "Subscribing and PLC data receiving"
    ...
    Private Sub PolledDataReturnedGreen(ByVal Values() As String)
        Try
            LightGreenValue = Values(0)
        Catch
            DisplayError("INVALID Green VALUE RETURNED!")
        End Try
    End Sub

    Private Sub PolledDataReturnedAmber(ByVal Values() As String)
        Try
            LightAmberValue = Values(0)
        Catch
            DisplayError("INVALID Amber VALUE RETURNED!")
        End Try
    End Sub

    Private Sub PolledDataReturnedRed(ByVal Values() As String)
        Try
            LightRedValue = Values(0)
        Catch
